...
public class ind3 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/ind3.png?alt=media&token=b7c658c6-3c9a-4e3a-be8e-7c572b7bc608";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ind3.this, teamindia.class);
