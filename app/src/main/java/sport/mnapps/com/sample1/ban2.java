...
public class ban2 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/ban2.png?alt=media&token=2b0278d5-2a28-4eec-b264-f9a0fee81ad9";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ban2.this, teambangladesh.class);
