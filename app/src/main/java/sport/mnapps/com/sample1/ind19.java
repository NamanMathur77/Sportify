...
public class ind19 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/ind19.png?alt=media&token=6ddd0d01-2f96-4fa3-825c-7ce4a72228bc";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ind19.this, teamindia.class);
