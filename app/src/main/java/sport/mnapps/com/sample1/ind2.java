...
public class ind2 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/ind2.png?alt=media&token=ac819147-b403-4078-9138-6f62009f49d5";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ind2.this, teamindia.class);
