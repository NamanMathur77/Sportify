...
public class ind8 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/ind8.png?alt=media&token=0e26c03a-8a0d-4239-90fa-737671173b41";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ind8.this, teamindia.class);
