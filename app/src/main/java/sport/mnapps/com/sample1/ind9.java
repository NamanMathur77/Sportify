...
public class ind9 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/ind9.png?alt=media&token=777e70b6-a854-444a-a0bf-6ac224664a4a";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ind9.this, teamindia.class);
