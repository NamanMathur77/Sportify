...
public class ban6 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/ban6.png?alt=media&token=ebee13bf-9acd-4eec-bd89-01d0ac9d08aa";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ban6.this, teambangladesh.class);
