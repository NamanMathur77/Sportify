...
public class ind11 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/ind11.png?alt=media&token=fb3e3069-f1c9-45f2-a82b-e7451e3906d4";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ind11.this, teamindia.class);
