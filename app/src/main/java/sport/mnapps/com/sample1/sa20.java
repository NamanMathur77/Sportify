...
public class sa20 extends AppCompatActivity {
    ...
    String url = "https://firebasestorage.googleapis.com/v0/b/sample1-ae95d.appspot.com/o/Screenshot%20(144).png?alt=media&token=fe243afb-1777-4898-9d87-8417ddc585ad";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(sa20.this, teamsa.class);
